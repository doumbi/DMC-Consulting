                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="card">
                                    ...
                                    <form action="{{route('createTeam')}}" method="post"  class="form-horizontal">
                                        @csrf
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text"  id="nom" name="nom" required="required" class=" @error('nom') is-invalid @enderror form-control ">
                                                      @error('nom')
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text"  id="fonction" name="fonction" required="required" class=" @error('fonction') is-invalid @enderror form-control ">
                                                      @error('fonction')
                                                          <p class="text-danger" role="alert">
                                                              <strong>{{ $message }}</strong>
                                                          </p>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <textarea type="text"  id="presentation" name="presentation" required="required" class=" @error('message') is-invalid @enderror form-control "></textarea>
                                                      @error('presentation')
                                                          <p class="text-danger" role="alert">
                                                              <strong>{{ $message }}</strong>
                                                          </p>
