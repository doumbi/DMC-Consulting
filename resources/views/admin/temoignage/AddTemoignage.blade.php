                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="card">
                                    ...
                                    <form action="{{route('createTemoin')}}" method="post"  class="form-horizontal">
                                        @csrf
                                            ...
                                            <div class="row form-group">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <textarea type="text"  id="message" name="message" required="required" class=" @error('message') is-invalid @enderror form-control "></textarea>
                                                      @error('message')
                                                          <p class="text-danger" role="alert">
                                                              <strong>{{ $message }}</strong>
                                                          </p>
